...
if st.button("🔮 Prediksi Status Mahasiswa", type="primary"):
    ...
    if status == "Dropout":
        ...
        st.info("Mahasiswa ini masih terdaftar (Enrolled). Monitoring terus performanya.")
    else:
...
# Footer
st.markdown("---")
st.caption("Dibangun untuk Proyek Akhir Jaya Jaya Institut | Model: Random Forest | Hanya 8 fitur terpenting yang diperlukan")
